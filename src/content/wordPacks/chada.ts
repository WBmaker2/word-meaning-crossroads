  ...
  scenes: [
    {
      ...
      wrongChoiceFeedback: { 'chada:kick': '‘공을’과 ‘발로’라는 단서가 발로 차는 행동을 가리켜요.', 'chada:wear': '손목에 두르는 물건이 아니라 ‘발로 공을’ 힘껏 건드린 장면인지 비교해 보아요.', 'insufficient-context': '‘공을’과 ‘발로’가 남아 있어 발로 차기인지 살펴볼 수 있어요.' }, audioSrc: '/audio/scenes/chada-kick-01.mp3', illustrationId: 'crossroads-chada',
    },
    {
      ...
      wrongChoiceFeedback: { 'chada:wear': '‘시계를’과 ‘손목에’라는 단서가 몸에 차는 행동을 가리켜요.', 'chada:fill': '물이 가득해진 웅덩이가 아니라 ‘손목에 시계를’ 두른 장면인지 비교해 보아요.', 'insufficient-context': '‘손목에’와 ‘시계를’이 남아 있어 몸에 차기인지 살펴볼 수 있어요.' }, audioSrc: '/audio/scenes/chada-wear-02.mp3', illustrationId: 'crossroads-chada',
    },
    {
      ...
      wrongChoiceFeedback: { 'chada:fill': '‘물이’와 ‘가득’이라는 단서가 물이 차오른 상태를 가리켜요.', 'chada:kick': '공을 발로 찬 행동이 아니라 ‘웅덩이에 물이 가득’ 찬 장면인지 비교해 보아요.', 'insufficient-context': '‘물이’와 ‘가득’이 남아 있어 물이 차오르기인지 살펴볼 수 있어요.' }, audioSrc: '/audio/scenes/chada-fill-03.mp3', illustrationId: 'crossroads-chada',
    },
  ],
