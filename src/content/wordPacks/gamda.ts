...
export const gamda = {
  ...
  meanings: [
    ...
    { id: 'gamda:wash', childFriendlyLabel: '머리를 감기', childFriendlyDescription: '물로 머리카락을 씻는 행동', contrastExample: '따뜻한 물로 머리를 감습니다.' },
  ],
  scenes: [
    {
      ...
      wrongChoiceFeedback: { 'gamda:close': '‘눈을’과 ‘잠들기 전에’라는 단서가 눈을 감는 행동을 가리켜요.', 'gamda:wind': '상자 둘레에 끈을 두른 장면이 아니라 ‘잠들기 전에 눈을’ 닫은 행동인지 비교해 보아요.', 'insufficient-context': '‘눈을’과 ‘잠들기 전에’가 남아 있어 눈을 감기인지 살펴볼 수 있어요.' }, illustrationId: 'crossroads-gamda',
    },
    {
      ...
      wrongChoiceFeedback: { 'gamda:wind': '‘리본을’과 ‘선물 상자에’라는 단서가 둘러 감는 행동을 가리켜요.', 'gamda:wash': '물로 머리를 씻은 장면이 아니라 ‘상자에 리본을 여러 번’ 두른 행동인지 비교해 보아요.', 'insufficient-context': '‘리본을’과 ‘선물 상자에’가 남아 있어 둘러 감기인지 살펴볼 수 있어요.' }, illustrationId: 'crossroads-gamda',
    },
    {
      ...
      wrongChoiceFeedback: { 'gamda:wash': '물로 머리를 씻는 장면이라는 단서가 머리를 씻는 행동을 가리켜요.', 'gamda:close': '눈꺼풀을 내린 장면이 아니라 ‘물로 머리를’ 씻은 행동인지 비교해 보아요.', 'insufficient-context': '물과 머리를 씻는 장면이 남아 있어 머리를 감기인지 살펴볼 수 있어요.' }, illustrationId: 'crossroads-gamda',
    },
  ],
