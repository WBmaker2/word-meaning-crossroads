  ...
  scenes: [
    {
      ...
      wrongChoiceFeedback: { 'mal:horse': '‘달렸습니다’와 ‘네 다리로’라는 단서가 달리는 동물인 말을 가리켜요.', 'mal:speech': '듣거나 건넨 말이 아니라 ‘목장’에서 네 다리로 달린 장면인지 비교해 보아요.', 'insufficient-context': '‘달렸습니다’와 ‘목장의’가 남아 있어 달리는 동물인지 살펴볼 수 있어요.' }, illustrationId: 'crossroads-mal',
    },
    {
      ...
      wrongChoiceFeedback: { 'mal:speech': '‘듣고’와 ‘친구의 따뜻한’이라는 단서가 주고받는 말을 가리켜요.', 'mal:horse': '달리는 동물의 움직임이 아니라 ‘친구의 말을 듣고’ 기분이 좋아진 장면인지 비교해 보아요.', 'insufficient-context': '‘친구의 말을 듣고’가 남아 있어 주고받는 말인지 살펴볼 수 있어요.' }, illustrationId: 'crossroads-mal',
    },
    {
      ...
      wrongChoiceFeedback: { 'mal:horse': '‘좋아합니다’만으로는 달리는 동물인지 주고받는 말인지 결정되지 않아요.', 'mal:speech': '듣거나 말한 상황이 없어 주고받는 말이라고 정할 수 없어요.', 'insufficient-context': '동물의 움직임이나 대화 단서가 없어서 ‘말’의 뜻을 정하기 어려워요.' }, illustrationId: 'crossroads-mal',
    },
  ],
