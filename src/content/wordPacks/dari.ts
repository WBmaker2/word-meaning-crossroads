...
export const dari = {
  ...
  meanings: [
    ...
    { id: 'dari:bridge', childFriendlyLabel: '건너는 다리', childFriendlyDescription: '강이나 길 위를 건너도록 이어 놓은 시설', contrastExample: '강 위의 다리를 건넙니다.' },
  ],
  scenes: [
    {
      ...
      wrongChoiceFeedback: { 'dari:leg': '‘아팠습니다’와 ‘두’라는 단서가 몸의 다리를 가리켜요.', 'dari:bridge': '강을 건너는 시설이 아니라 ‘달렸더니 두 다리가 아픈’ 몸의 상태인지 비교해 보아요.', 'insufficient-context': '‘달렸더니’와 ‘아팠습니다’가 남아 있어 몸의 다리인지 살펴볼 수 있어요.' }, audioSrc: '/audio/scenes/dari-leg-01.mp3', illustrationId: 'crossroads-dari',
    },
    {
      ...
      wrongChoiceFeedback: { 'dari:bridge': '‘건너’와 ‘강 위의’라는 단서가 건너는 다리를 가리켜요.', 'dari:leg': '걷다가 아픈 몸의 부분이 아니라 ‘강 위의 다리를 건너’는 시설인지 비교해 보아요.', 'insufficient-context': '‘건너’와 ‘강 위의’가 남아 있어 건너는 다리인지 살펴볼 수 있어요.' }, audioSrc: '/audio/scenes/dari-bridge-02.mp3', illustrationId: 'crossroads-dari',
    },
    {
      ...
      wrongChoiceFeedback: { 'dari:leg': '‘살펴보았습니다’만으로는 몸의 부분인지 건너는 시설인지 결정되지 않아요.', 'dari:bridge': '강이나 걷는 행동 같은 단서가 없어 건너는 다리라고 정할 수 없어요.', 'insufficient-context': '몸인지 시설인지 알려 주는 단서가 없어서 ‘다리’의 뜻을 정하기 어려워요.' }, audioSrc: '/audio/scenes/dari-uncertain-03.mp3', illustrationId: 'crossroads-dari',
    },
  ],
  necessityChallenge: { id: 'necessity-dari', wordId: 'dari', originalSentence: '강 위의 다리를 건넜습니다.', hiddenTokenText: '강 위의', sentenceAfterHide: '______ 다리를 건넜습니다.', expectedClarity: 'still-clear', explanation: '`건넜습니다`가 남아 건너는 시설인 다리라는 뜻을 알 수 있어요.' },
  repair: { id: 'repair-dari', wordId: 'dari', ambiguousSentence: '우리는 다리를 살펴보았다.', solutions: [
    { id: 'dari-bridge', meaningId: 'dari:bridge', blockLabel: '건너는 시설', completedSentence: '우리는 강 위에 놓인 다리를 살펴보았다.', reviewNote: '강 위에 놓인 시설임을 덧붙였어요.' },
    { id: 'dari-leg', meaningId: 'dari:leg', blockLabel: '몸의 부분', completedSentence: '우리는 달리다 아픈 다리를 살펴보았다.', reviewNote: '달리다 아픈 몸의 부분임을 덧붙였어요.' },
  ] },
