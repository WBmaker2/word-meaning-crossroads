  ...
  scenes: [
    {
      ...
      wrongChoiceFeedback: { 'dari:leg': '‘아팠습니다’와 ‘두’라는 단서가 몸의 다리를 가리켜요.', 'dari:bridge': '강을 건너는 다리가 아니라 ‘달렸더니 두 다리가 아픈’ 몸의 상태인지 비교해 보아요.', 'insufficient-context': '‘달렸더니’와 ‘아팠습니다’가 남아 있어 몸의 다리인지 살펴볼 수 있어요.' }, illustrationId: 'crossroads-dari',
    },
    {
      ...
      wrongChoiceFeedback: { 'dari:bridge': '‘건너’와 ‘강 위의’라는 단서가 건너는 다리를 가리켜요.', 'dari:leg': '걷다가 아픈 몸의 부분이 아니라 ‘강 위의 다리를 건너’는 장면인지 비교해 보아요.', 'insufficient-context': '‘건너’와 ‘강 위의’가 남아 있어 건너는 다리인지 살펴볼 수 있어요.' }, illustrationId: 'crossroads-dari',
    },
    {
      ...
      wrongChoiceFeedback: { 'dari:leg': '‘살펴보았습니다’만으로는 몸의 부분인지 건너는 다리인지 결정되지 않아요.', 'dari:bridge': '강이나 걷는 행동 같은 단서가 없어 건너는 다리라고 정할 수 없어요.', 'insufficient-context': '몸의 부분인지 건너는 다리인지 알려 주는 단서가 없어서 ‘다리’의 뜻을 정하기 어려워요.' }, illustrationId: 'crossroads-dari',
    },
  ],
