  ...
  scenes: [
    {
      ...
      wrongChoiceFeedback: { 'sseuda:write': '‘일기에’와 ‘연필로 오늘 일을’이라는 단서가 글을 쓰는 행동을 가리켜요.', 'sseuda:wear': '머리에 모자를 덮은 장면이 아니라 ‘일기에 연필로’ 적은 행동인지 비교해 보아요.', 'insufficient-context': '‘일기에’와 ‘연필로’가 남아 있어 글을 쓰기인지 살펴볼 수 있어요.' }, illustrationId: 'crossroads-sseuda',
    },
    {
      ...
      wrongChoiceFeedback: { 'sseuda:wear': '머리에 모자를 쓴다는 단서가 모자를 쓰는 행동을 가리켜요.', 'sseuda:bitter': '약을 먹은 맛이 아니라 ‘햇빛을 가리려고 머리에 모자를’ 쓴 장면인지 비교해 보아요.', 'insufficient-context': '머리에 모자를 쓴다는 말이 남아 있어 모자를 쓰기인지 살펴볼 수 있어요.' }, illustrationId: 'crossroads-sseuda',
    },
    {
      ...
      wrongChoiceFeedback: { 'sseuda:bitter': '‘맛이’와 ‘약을 먹어 보니’라는 단서가 쓴맛을 가리켜요.', 'sseuda:write': '글자를 적은 장면이 아니라 ‘약을 먹어 보니 맛이’ 쓴 상태인지 비교해 보아요.', 'insufficient-context': '‘맛이’와 ‘약을 먹어 보니’가 남아 있어 맛이 쓰기인지 살펴볼 수 있어요.' }, illustrationId: 'crossroads-sseuda',
    },
  ],
  necessityChallenge: { id: 'necessity-sseuda', wordId: 'sseuda', originalSentence: '나는 연필로 일기를 썼습니다.', hiddenTokenText: '연필로', sentenceAfterHide: '나는 ______ 일기를 썼습니다.', expectedClarity: 'still-clear', explanation: '‘일기를’이라는 말이 남아 글을 적은 뜻임을 알 수 있어요.' },
