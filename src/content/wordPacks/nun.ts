  ...
  scenes: [
    {
      ...
      wrongChoiceFeedback: { 'nun:snow': '‘내려’와 ‘하얗게’라는 단서가 하늘에서 내리는 눈을 가리켜요.', 'nun:eye': '눈으로 보는 행동이 아니라 ‘내려’ 운동장을 하얗게 만든 장면인지 비교해 보아요.', 'insufficient-context': '‘내려’와 ‘하얗게’가 남아 있어 내리는 눈인지 살펴볼 수 있어요.' },
